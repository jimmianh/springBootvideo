...
////            params = {"price", "unit_name"},
//            produces = { MediaType.APPLICATION_JSON_VALUE,
//                    MediaType.APPLICATION_XML_VALUE })
////    @ResponseBody
////    public int updateDrug(@Valid @RequestParam int drug_unit_id, BigDecimal price, String unit_name) {
////
////        System.out.println("(Service Side) Editing Drug: " + drug_unit_id +price+unit_name);
////
////
////        return drugEntityRepository.updateByUnitId(  drug_unit_id,  price,  unit_name);
////    }
    @RequestMapping(value = "/api/foos",
            method = RequestMethod.PUT,
            produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
    @ResponseBody
    public String addFoo(@RequestBody @Valid Foos foos) {
        return "ID: " + foos.getFooId()+ " Name: " + foos.getName();
    }
